      ...
      <div className="legal-page" style={{ maxWidth: 800, margin: '0 auto', padding: '4rem 2rem 6rem' }}>
        ...
        <div className="legal-notice" style={{
          ...
          <div style={{ display: 'flex', gap: 10, alignItems: 'flex-start' }}>
            ...
            <p style={{ color: 'rgb(163 158 153)', fontSize: '0.875rem', lineHeight: 1.7, margin: 0 }}>
              By registering a business account on {APP_NAME} you agree to these Terms.
        ...
        <Section title="1. Acceptance of Terms">
          <P>
            ...
            software, APIs, dashboards, and the ChatSeller chat widget.
          </P>
          <P>
            By creating an account, publishing a chat link, or using any
        ...
        <Section title="4. Account Responsibilities">
          <P>
            ...
            credentials. You must immediately notify us
        ...
        <Section title="7. Service Availability">
          <P>
            ...
            and events outside our control (including third-party infrastructure outages
        ...
        <Section title="9. Termination">
          ...
          <P>
            ...
            Obligations that by nature survive termination (including sections 5, 8, 10, and 11)
            remain in effect.
          </P>
        </Section>
