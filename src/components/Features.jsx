...
const FEATURES = [
  ...
  },
  {
    ...
    desc: 'Reply from your staff WhatsApp number and ChatSeller immediately steps back. No mode switching, no dashboard — just respond and ChatSeller knows to stay quiet until needed again.',
