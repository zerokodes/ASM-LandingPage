...
const FEATURES = [
  {
    ...
    desc: 'ChatSeller uses your product catalog, FAQs, and business knowledge to give accurate, personalized answers — not canned templates. Remembers history, handles follow-ups naturally.',
  ...
  },
  {
    ...
    desc: 'Sync products, services, prices and availability from your dashboard. ChatSeller can show images, compare options, and guide customers to the right purchase in real time.',
  ...
  },
  {
    ...
    desc: 'Jump into any conversation from the dashboard and ChatSeller immediately steps back. No mode switching — just respond and ChatSeller knows to stay quiet until needed again.',
  ...
  },
  {
    ...
    desc: 'Upload product sheets, policies, FAQs, or point ChatSeller at your website. It ingests everything and answers from your actual content, not made-up guesses.',
  ...
  },
  {
    ...
    desc: 'Get notified by email and in your dashboard when a customer places an order, asks something the AI can\'t answer, or when a conversation needs human attention.',
  ...
  },
  {
    ...
    desc: 'ChatSeller collects order details, confirms with customers, logs everything in your dashboard, and sends updates. No third-party e-commerce platform needed.',
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 2rem' }}>
        <div ref={titleRef} style={{ opacity: 0, textAlign: 'center', marginBottom: '3.5rem' }}>
          ...
          <p style={{ marginTop: '1rem', color: 'rgb(163 158 153)', fontSize: '1.05rem', maxWidth: 520, margin: '1rem auto 0' }}>
            ChatSeller isn&apos;t a chatbot with pre-set replies. It&apos;s a trained sales agent that knows
