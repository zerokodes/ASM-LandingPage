    ...
    <section ref={sectionRef} id="get-started" style={{ padding: '6rem 0', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 2rem', position: 'relative' }}>
        <div ref={contentRef} style={{
          ...
          <p style={{ color: 'rgb(120 113 108)', fontSize: '1.1rem', maxWidth: 540, margin: '0 auto 2.5rem', lineHeight: 1.7 }}>
          ...
          <div style={{ display: 'flex', flexWrap: 'wrap', gap: 16, justifyContent: 'center' }}>
            <a href="#" className="btn-primary" style={{ fontSize: '1rem', padding: '0.9rem 2rem' }}>
              Start Free Trial — No Card Needed
              <svg width="16" height="16" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 8l4 4m0 0l-4 4m4-4H3"/>
              </svg>
            </a>
            <a href="#" className="btn-ghost" style={{ fontSize: '1rem', padding: '0.9rem 2rem' }}>
