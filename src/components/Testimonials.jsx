...
const REVIEWS = [
  {
    ...
    avatar: 'AO',
    quote: 'Before ChatSeller I was answering chats from 6am to midnight. Now my AI handles 90% of inquiries automatically and I actually sleep.',
    metric: '90%',
  ...
  },
  {
    ...
    avatar: 'CE',
    quote: 'We handle 200+ orders per week entirely through our chat link now. ChatSeller logs everything, sends confirmations, and alerts us only for edge cases. It runs itself.',
    metric: '200+',
  ...
  },
  {
    ...
    avatar: 'BL',
    quote: 'We operate across 4 states and staff overhead for customer chat was killing us. ChatSeller standardized everything — same quality response whether Abuja or Port Harcourt.',
    metric: '4',
